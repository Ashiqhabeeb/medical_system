...
<html>
	...
	<!------------------starts first section----------------------->
		...
		<section>
			<h4 class="py-4 text-dark text-center text-h">"Find a doctor today and book your appointment online now"</h4>
			<div class="container-fluid bg-style media1">
			
				<div class="row">
					
					<div class="col-md-12 log-style">
						<form action="logcheck.php" name="login" method="post" class="m-auto py-3 jumbotron text-light p-3 form-style rounded">
